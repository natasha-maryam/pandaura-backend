...
exports.parseSTVariablesDetailed = parseSTVariablesDetailed;
exports.parseSTVariables = parseSTVariables;
/**
 ...
 */
function parseVariableLine(line, scope, vendor, lineNumber) {
 ...
 */
function parseInlineVariable(line, scope, vendor, lineNumber) {
 ...
 */
function mapVarBlockToScope(varBlockType) {
 ...
 */
function parseSTVariables(stCode) {
