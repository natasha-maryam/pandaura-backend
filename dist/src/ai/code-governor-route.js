...
const orchestrator_1 = require("./code-governor/orchestrator");
        ...
        if (stream === 'true') {
            ...
            const handleCodeGovernorStreaming = async () => {
                try {
                    ...
                    // Create orchestrator
                    const outDir = path_1.default.join(process.cwd(), 'generated-projects');
                    const orchestrator = new orchestrator_1.Orchestrator(outDir);
                    // Send status update
...
Would you like me to explain any specific part of the generated code or help with the implementation process?`,
                    ...
                    const errorMessage = error instanceof orchestrator_1.CodeGenError
