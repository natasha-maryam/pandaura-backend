export const SPEC_CONTRACT_SYSTEM = `You produce STRICT JSON contracts for PLC control projects.
...
export const SPEC_CONTRACT_USER = `Build a complete contract from the following spec. Resolve ambiguities conservatively.
